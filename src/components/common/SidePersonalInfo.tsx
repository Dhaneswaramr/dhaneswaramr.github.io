        ...
        <div className="flex flex-col gap-5 xl:gap-7 text-sm xl:text-md">
            ...
            <div className="flex flex-row items-center justify-center gap-7">
                ...
                <div className="flex flex-col flex-4">
                    ...
                    <h6 className="font-bold break-words">{data.email}</h6>
                </div>
            </div>
            ...
            <div className="flex flex-row items-center justify-center gap-7">
                ...
                <div className="flex flex-col flex-4">
                    ...
                    <h6 className="font-bold break-words">{data.phone}</h6>
                </div>
            </div>
            ...
            <div className="flex flex-row items-center justify-center gap-7">
                ...
                <div className="flex flex-col flex-4">
                    ...
                    <h6 className="font-bold break-words">{moment(data.birth_date).format("DD/MM/YYYY")}</h6>
                </div>
            </div>
            ...
            <div className="flex flex-row items-center justify-center gap-7">
                ...
                <div className="flex flex-col flex-4">
                    ...
                    <h6 className="font-bold break-words">{data.address}</h6>
                </div>
            </div>
            <hr className="border-t-1 border-orange-300" />
        </div>
